...
//Validate that either the airport location code or address should be specified and not both
...
//Optional information for flight - Flight name and Flight code
...
echo "<b>Please verify the information below and if there is any errors then please go back and correct them first for faster and accurate service.</b><br/><br/>";
...
echo "<p><font color=\"black\"><b>Here is all the information submitted for Renting the Car:</b><br/><br/>";
...
if($count > 0)
{
	echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p>You have <font color=\"red\">" . $count . " </font> Errors. <br/>" ;
}
